...
<div class="theme-wrap clearfix">
    ...
    <div class="banner-container">
        ...
        <img src="images/trl.png" alt="item slide">
            ...
            <div class="search-form-wrap">
                <form class="clearfix" name="search" action="serviceman-search.php" method="post">
                    ...
                    <div class="select-field-wrap pull-left">
                        ...
                        <select name="location" required class="search-form-select">

                            <option value="" class="options" selected disabled>location</option>
                            ...
                            <ul class="cat-list">
                                ...
                                if ($query->rowCount() > 0) {
                                    foreach ($results as $row) { ?>
                                        <li>
                                            <a href="view-category-detail.php?viewid=<?php echo htmlentities($row->Category); ?>"><?php echo htmlentities($row->Category); ?>
