                                    ...
                                    <div id="latest-listing" class="tab-pane active">
                                        <div class="listing-wrapper three-column row">
                                            ...
                                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                                // form has been submitted, execute code
                                            ...
                                            $sql = "SELECT * from  tblperson where (Category=:cat and City like '%$location%')";
                                            if ($categories == 'all-categories') {
                                                $sql = "SELECT * from  tblperson where (not Category=:cat and City like '%$location%')";
                                            }
                                                ...
                                                foreach ($results as $row) { ?>
                                                    <div class="item col-md-4 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="listing-item clearfix">
                                                            ...
                                                            <div class="figure">
                                                                <img src="admin/images/<?php echo $row->Picture; ?>"
                                                                     alt="listing item" height="200" width="200"/>
                                                            ...
                                                            <div class="listing-content clearfix">
                                                                ...
                                                                <div class="listing-title">
                                                                    <h6>
                                                                        <a href="single-person-detail.php?viewid=<?php echo htmlentities($row->ID); ?>"><?php echo $row->Name; ?></a>
                                                                    </h6>
                                                                </div>
