                            ...
                            <div class="listing-contact-detail-wrap">
                                ...
                                <div class="listing-contact-section-table">
                                    ...
                                    <div class="listing-contact-table-field">
                                        <ul>
                                            <li class="info" style="font-weight:bold">Category</li>
                                    ...
                                    <div class="listing-contact-table-field">
                                        <ul>
                                            <li class="info" style="font-weight:bold">Name</li>
                                            <li class="details"><?php echo $row->Name; ?> </li>
                                        </ul>
                                    </div>
                                    <div class="listing-contact-table-field">
                                        <ul>
                                            <li class="info" style="font-weight:bold">Mobile Number</li>
                                            <li class="details"><?php echo $row->MobileNumber; ?></li>
                                        </ul>
                                    </div>
                                    <div class="listing-contact-table-field">
                                        <ul>
                                            <li class="info" style="font-weight:bold">Address</li>
                                            <li class="details"><?php echo $row->Address; ?></li>
                                        </ul>
                                    </div>
                                    <div class="listing-contact-table-field">
                                        <ul>
                                            <li class="info" style="font-weight:bold">Working from</li>
                                            <li class="details"><?php echo date("H:i", strtotime($row->StartTime)); ?></li>
                                        </ul>
                                    </div>
                                    <div class="listing-contact-table-field">
                                        <ul>
                                            <li class="info" style="font-weight:bold">Working till</li>
                        ...
                        <div class="sidebar-widget shadow-1">
                            ...
                            <div class="sidebar-widget-content advertise  clearfix">
                                <div class="sidebar-image-ads">
                                    <img src="craftsmanship/images/<?php echo $row->Picture; ?>" height="195"
                                         width="300" alt="listing item"/>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript"
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBueyERw9S41n4lblw5fVPAc9UqpAiMgvM&amp;sensor=false"></script>
