...
<head>
    <title>Local Services Search Engine Mgmt System | Change Password</title>
    <!-- Font Awesome -->
                                        ...
                                        <form name="changepassword" method="post" onsubmit="return checkpass();" action="">
                                            ...
                                            <div class="card-body card-block">
                                                ...
                                                <div class="form-group"><label for="company" class=" form-control-label">Current
                                                        Password</label><input type="password" name="currentpassword" id="currentpassword" class="form-control" required=""></div>
